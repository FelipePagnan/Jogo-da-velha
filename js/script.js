...
//limpando o jogo, declarando o resultado e atualizando o placar
...
function computerPlay(){
    ...
    for(let i = 0; i < boxes.length; i ++){
        ...
        //so preenchere se estiver vazio
        if(boxes[i].childNodes[0] == undefined){
            if(randomNumber <= 1){
        ...
        //verica quantas estao preenchidas
        else{
            filled++;
        }
    }
